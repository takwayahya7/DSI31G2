...
import com.iset.mealtray.ui.order.AccompanimentMenuFragment
import com.iset.mealtray.ui.order.CheckoutFragment
import com.iset.mealtray.ui.order.EntreeMenuFragment
import com.iset.mealtray.ui.order.SideMenuFragment
...
class OrderFunctionalityTests : BaseTest() {
     ...
     */
    @Test
    private fun radio_buttons_update_entree_menu_subtotal() {
        // Launch the entree menu fragment
        launchFragmentInContainer<EntreeMenuFragment>(themeResId = R.style.Theme_MealTray)
    ...
    fun radio_buttons_update_side_menu_subtotal() {
        ...
        launchFragmentInContainer<SideMenuFragment>(themeResId = R.style.Theme_MealTray)
    ...
    fun radio_buttons_update_accompaniment_menu_subtotal() {
        // Launch the side menu fragment
        launchFragmentInContainer<AccompanimentMenuFragment>(themeResId = R.style.Theme_MealTray)
